...
class MapRepo {
    ...
    constructor() {
        val reg1 = Region("reg1","1", arrayListOf(ImagePoint(10, 10), ImagePoint(200, 200), ImagePoint(50, 250)))
        val reg2 = Region("reg2", "2",arrayListOf(ImagePoint(10, 300), ImagePoint(200, 400), ImagePoint(50, 600)))
